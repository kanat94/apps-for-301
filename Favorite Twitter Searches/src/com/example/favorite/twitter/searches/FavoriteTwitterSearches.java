package com.example.favorite.twitter.searches;
...
public class FavoriteTwitterSearches extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // register listeners for the Save and Clear Tags Button
        ...
        refreshButtons(null); // add previously saved search to GUI
    } // end method onCreat
    ...
    public OnClickListener queryButtonListener = new OnClickListener() {
    	...
    	public void onClick(View v) {
    		...
    		startActivity(getURL); // execute Intent
    	} // end method onClick
    }; // end method OnClickListener anonymous inner class
    ...
    }; // end OnClickLisstener anonymous inner class
